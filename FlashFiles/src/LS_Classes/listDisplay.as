package LS_Classes
{
			...
			public class listDisplay extends MovieClip
			{
						...
						public function get visibleHeight() : Number
						{
									...
									if(_loc2_)
									{
												_loc1_ = this.getElementHeight(_loc2_);
									}
									return _loc1_;
						}
						...
						public function moveElementsToPosition(param1:Number = 0.8, param2:Boolean = false) : *
						{
									...
									while(_loc5_ < this.content_array.length)
									{
												...
												_loc6_.list_tweenY = new larTween(_loc6_,"y",this.m_PositionTweenFunc,_loc6_.y,_loc3_,param1,this.removeTweenState,_loc6_.list_id);
												if(param2 || this.m_sideSpacing != 0)
												{
															_loc6_.list_tweenX = new larTween(_loc6_,"x",this.m_PositionTweenFunc,_loc6_.x,this.m_sideSpacing,param1);
												}
